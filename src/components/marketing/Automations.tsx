      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto mb-8 md:mb-12">
          {automations.map((automation, index) => (
            <motion.div 
              key={index}
              className="bg-white dark:bg-gray-800 rounded-lg p-4 md:p-6 shadow-lg border border-gray-200 dark:border-gray-700 relative overflow-hidden group"
              initial={{ opacity: 0, y: 50 }}
              animate={inView ? { opacity: 1, y: 0 } : { opacity: 0, y: 50 }}
            ...
            >
              ...
              <h3 className="text-lg md:text-xl font-bold text-gray-900 dark:text-white mb-2 relative z-10">
                {automation.title}
              </h3>
