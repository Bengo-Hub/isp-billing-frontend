    ...
    <section className="py-12 md:py-16 lg:py-20 bg-muted">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 max-w-6xl mx-auto mb-8 md:mb-12">
          <motion.div 
            className="bg-card rounded-lg p-6 md:p-8 shadow-lg border border-border"
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-xl md:text-2xl font-bold text-foreground">Active Users</h3>
              <motion.span 
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-xl md:text-2xl font-bold text-foreground">Revenue Today</h3>
              <motion.span 
                className="bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 px-3 py-1 rounded-full text-sm font-medium"
                animate={{ scale: [1, 1.05, 1] }}
