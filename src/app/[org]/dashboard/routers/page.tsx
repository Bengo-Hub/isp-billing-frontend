    ...
    <div className="w-full p-3 sm:p-6 space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div className="flex-1 min-w-0">
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900">MikroTik Routers</h1>
          <p className="text-sm sm:text-base text-gray-600 mt-1">Manage your MikroTik routers on this page.</p>
        </div>
        <div className="flex flex-wrap gap-2 sm:gap-3">
          <Button variant="outline" size="sm" className="bg-blue-50 hover:bg-blue-100 text-blue-700 flex-1 sm:flex-none">
            <Monitor className="h-4 w-4 sm:mr-2" />
            <span className="hidden sm:inline">Tutorial</span>
          </Button>
          <Button size="sm" className="bg-brand-600 hover:bg-brand-700 flex-1 sm:flex-none" onClick={() => router.push(`/${orgSlug}/dashboard/routers/provision`)}>
            <Monitor className="h-4 w-4 sm:mr-2" />
            Link a MikroTik
          </Button>
        </div>
                ...
                <TableCell>
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      <DropdownMenuItem onClick={() => router.push(`/${orgSlug}/dashboard/routers/${r.id}`)}>
                      ...
                      <DropdownMenuItem onClick={() => router.push(`/${orgSlug}/dashboard/routers/provision?reprovision=${r.id}`)}>
