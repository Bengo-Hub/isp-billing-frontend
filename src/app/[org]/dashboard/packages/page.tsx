    ...
    <div className="w-full max-w-7xl mx-auto p-3 sm:p-6 space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-2 sm:gap-3">
          <Button variant="outline" size="sm" className="flex-1 sm:flex-none" onClick={() => setIsTemplatesDialogOpen(true)}>
            <Star className="h-4 w-4 sm:mr-2" />
            <span className="hidden sm:inline">Quick Templates</span>
          </Button>
          <Button variant="outline" size="sm" className="flex-1 sm:flex-none">
            <HelpCircle className="h-4 w-4 sm:mr-2" />
            <span className="hidden sm:inline">Package Guide</span>
          </Button>
          <Button
            size="sm"
        ...
        <div className="flex items-center gap-4 sm:gap-6 min-w-max sm:min-w-0">
          {tabs.map((tab) => (
            <button
              ...
              className={`py-3 px-1 border-b-2 font-medium text-xs sm:text-sm flex items-center gap-2 shrink-0 ${
                activeTab === tab.id
